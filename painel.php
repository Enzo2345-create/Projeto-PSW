...
<main>
    ...
    <section class="hero">
        ...
        <div class="hero-content">
            ...
            <h1>OLÁ, <?= strtoupper($_SESSION['usuario']) ?>!</h1>
            <p>Explore o futebol mundial, monte seu Dream Team e vote nos melhores da Copa 2026.</p>
        </div>
    </section>
    ...
    <section class="features">
        ...
        <div class="cards">
            <a href="selecoes.php" class="card" id="card-selecoes">
                ...
                <p>Conheça a história completa de cada seleção campeã do mundo desde 1930.</p>
            ...
            <a href="dreamteam.php" class="card" id="card-dreamteam">
                ...
                <p>Monte seu time ideal utilizando jogadores históricos das Copas do Mundo.</p>
